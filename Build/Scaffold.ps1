...
$viewFiles = Get-ChildItem -Path $config.DatabaseViewsDir -File

$tablesAndViews = Compare-Object $tablesFiles $viewFiles -PassThru -IncludeEqual #union

$tablesCompared = Compare-Object -ReferenceObject ($tablesAndViews) -DifferenceObject ($lookupTablesFiles) -Property BaseName  | Where-Object{$_.sideIndicator -eq "<="}

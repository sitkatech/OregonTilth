...
GO
ALTER TABLE [dbo].[TransplantProductionLaborActivityByCrop]  WITH CHECK ADD  CONSTRAINT [CK_TransplantProductionLaborActivityByCrop_Occurrances_Greater_Than_Zero] CHECK  (([Occurrances]>(0)))
GO

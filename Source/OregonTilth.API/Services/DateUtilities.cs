...
namespace OregonTilth.API.Services
{
    public static class DateUtilities
    {
        ...
        /// <summary>
        /// Tests if two given pefrescads overlap each other.
        /// </summary>
        /// <param name="startDate1">Base pefrescad start</param>
        /// <param name="endDate1">Base pefrescad end</param>
        /// <param name="startDate2">Test pefrescad start</param>
        /// <param name="endDate2">Test pefrescad end</param>
        /// <returns>
        /// 	<c>true</c> if the pefrescads overlap; otherwise, <c>false</c>.
        /// </returns>
